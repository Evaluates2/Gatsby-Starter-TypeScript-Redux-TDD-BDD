...
Then('I should see the todo list.', expected => {
    ...
    const firstTodoDescription = cy.get("p:contains(This is a very interesting description.)")
    const secondTodoHeader = cy.get("h1:contains(Second Thing)")
    const secondTodoDescription = cy.get("p:contains(This is a another interesting description.)")
